<template>
    <view class="app-container">
        <u-navbar :is-back='true' back-text="返回" title="搜索"></u-navbar>
        <view class="search-box">
            ...
            <u-search :placeholder="defaultKeyword" @search="doSearch(false)" @change="inputChange"
                :action-style="searchTextStyle" @custom="doSearch(false)" v-model="keyword">
            </u-search>
            <!-- <view class="input-box">
                <input type="text" :adjust-position="true" :placeholder="defaultKeyword" @input="inputChange"
                    v-model="keyword" @confirm="doSearch(false)" placeholder-class="placeholder-class"
                    confirm-type="search">
            </view>
    ...
    export default {
        ...
        methods: {
            ...
            doSearch(keyword) {
                ...
                // 跳转到商品列表页
                uni.redirectTo({
                    url: '/pages/goods/list/index?keyword=' + keyword
                })
...
<style lang="scss">
    ...
    .search-box .search-btn {
        ...
        font-size: 28upx;
        color: #fff;
        background: linear-gradient(to right, #d47048, #ff570a);
        border-radius: 60upx;
    }
    ...
    .keyword-entry {
        ...
        align-items: center;
        border-bottom: solid 1upx #929292;
    }
